...
# Fixture: flaky_spec.rb fails on attempts 1 and 2 and passes from attempt 3, counting attempts in HOPPER_FIXTURE_STATE_DIR so retries by different processes share the count; stable_spec.rb always passes.
